    ...
    return (
        <div>
            ...
            >
                ...
                <SwiperSlide className='slider7 hero-overlay'>
                    <div className=' w-full px-5 md:px-10 md:w-[70%] mx-auto text-center'>
