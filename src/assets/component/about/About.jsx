        ...
        <div>
            ...
            <div className="hero min-h-screen bg-base-200">
                ...
                <div className="w-[90%] mx-auto py-10 md:py-20">
                    <h1 data-aos="fade-top" className="text-3xl md:text-5xl  font-bold pb-10 md:pb-20 text-center">Welcome to Our Hospitality</h1>
                    ...
                    <div  className="hero-content grid grid-cols-1 md:grid-cols-2 gap-10 py-10 md:py-20">
                        <img data-aos="fade-right" src="https://static01.nyt.com/images/2019/03/24/travel/24trending-shophotels1/24trending-shophotels1-superJumbo.jpg" className=" rounded-lg" />
                   ...
                   <div className="w-full md:w-[50%] "data-aos="fade-right">
                    ...
                    <div className="hero-content grid grid-cols-1 md:grid-cols-2 gap-10 py-10 md:py-20">
                        <img data-aos="fade-right" src="https://cdn.firstcry.com/education/2022/07/05124744/The-Park-10-lines-short-and-long-essay-for-children1.jpg" className=" rounded-lg rounded-2xl" />
                        <div data-aos="fade-left">
